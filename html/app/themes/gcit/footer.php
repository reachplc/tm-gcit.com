	...
	<div class="row cyan-dark">
		<div class="wrapper-footer">
			...
			<!-- <div class="large-3 columns no-pad m-tb">
				<?php if ( ! function_exists( 'dynamic_sidebar' ) || ! dynamic_sidebar( 'foot-col-1' ) ) : ?>
				<?php endif; ?>
			</div>
			<div class="large-3 columns m-tb">
				<?php if ( ! function_exists( 'dynamic_sidebar' ) || ! dynamic_sidebar( 'foot-col-1a' ) ) : ?>
				<?php endif; ?>
			</div>
			<div class="large-6 columns no-pad m-tb">
				<?php if ( ! function_exists( 'dynamic_sidebar' ) || ! dynamic_sidebar( 'foot-col-2' ) ) : ?>
				<?php endif; ?>
			</div> -->
		</div>
		<!-- wrapper -->
