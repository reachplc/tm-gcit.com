...
<div class="home-what" >
    ...
    <div class="large-6 right">
        <div class="how-cell-dark-right">
          ...
          <span class="whattexth1">GCIT was the driving force behind the roll-out of ContentWatch and CHP to all parts of Trinity Mirror. </span>
          <br /><br />

          <span class="whattextp">With that task behind them, the team are in a constant battle to upgrade and improve editorial systems. </span>
          <br /><br />
  ...
  <div class="large-6 left">
    ...
    <div class="large-6 right">
        <div class="who-cell-dark-right">
          ...
          <span class="whattextp_white">He worked for the Post &amp; Mail 34 years from down-table sub to a stint as deputy editor of the Birmingham Mail before leading the Midlands ContentWatch roll-out in 2008.</span>
          <br /><br />
