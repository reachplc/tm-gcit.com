...
add_action( 'wp_enqueue_scripts', 'careers_scripts_videos' );
...
function twentythirteen_widgets_init() {
	...
	register_sidebar( array(
		'name'          => __( 'Footer Column 1', 'twentythirteen' ),
		'id'            => 'foot-col-1',
		'description'   => __( 'Appears on left handside of footer.', 'twentythirteen' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h3 class="widget-title">',
		'after_title'   => '</h3>',
	...
	register_sidebar( array(
		'name'          => __( 'Footer Column 1a', 'twentythirteen' ),
		'id'            => 'foot-col-1a',
		'description'   => __( 'Appears on left handside of footer.', 'twentythirteen' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
	...
	register_sidebar( array(
		'name'          => __( 'Footer Column 2', 'twentythirteen' ),
		'id'            => 'foot-col-2',
		'description'   => __( 'Appears in center of footer.', 'twentythirteen' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h3 class="widget-title">',
		'after_title'   => '</h3>',
	...
	register_sidebar( array(
		...
		'id'            => 'blog-sidebar',
		'description'   => __( 'Appears on right handside of blog page.', 'twentythirteen' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h4 class="grey-dark news-heading">',
		'after_title'   => '</h4>',
	) );

	register_sidebar( array(
		'name'          => __( 'Courses Homepage', 'twentythirteen' ),
		'id'            => 'courses-homepage',
		'description'   => __( 'Appears at bottom of home page.', 'twentythirteen' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h3 class="widget-title">',
		'after_title'   => '</h3>',
...
if ( ! function_exists( 'twentythirteen_paging_nav' ) ) :
	...
	function twentythirteen_paging_nav() {
		...
		?>
			...
			<h5 class="screen-reader-text"><?php esc_html_e( 'Posts navigation', 'twentythirteen' ); ?></h5>
					<div class="nav-links">
...
if ( ! function_exists( 'twentythirteen_post_nav' ) ) :
	...
	?>
		...
		<h5 class="screen-reader-text"><?php esc_html_e( 'Read more posts:', 'twentythirteen' ); ?></h5>
				<div class="nav-links">
...
if ( ! function_exists( 'twentythirteen_entry_meta' ) ) :
	...
	function twentythirteen_entry_meta() {
		if ( is_sticky() && is_home() && ! is_paged() ) {
			printf( '<span class="featured-post">%1$s</span>', esc_html__( 'Sticky', 'twentythirteen' ) );
		}
		...
		if ( $categories_list ) {
			printf( '<span class="categories-links">%1$s</span>', esc_html( $categories_list ) );
		}
